...
IF(PKG_CONFIG_FOUND)
  ...
  FIND_LIBRARY(LibUSB_LIBRARY_STATIC
      NAMES libusb-1.0.a
      HINTS ${LibUSB_LIBRARY_DIRS}
      )
  
  SET(LibUSB_LIBRARIES ${LibUSB_LIBRARY})
  SET(LibUSB_LIBRARIES_STATIC ${LibUSB_LIBRARY_STATIC})

  MESSAGE(STATUS "LIBUSB_DIR: ${LibUSB_LIBRARY_DIRS}")
  MESSAGE(STATUS "LibUSB_LIBRARY: ${LibUSB_LIBRARIES}")
  MESSAGE(STATUS "LibUSB_LIBRARIES_STATIC: ${LibUSB_LIBRARIES_STATIC}")
  RETURN()
ENDIF()
...
FIND_LIBRARY(LibUSB_LIBRARIES_STATIC
  NAMES ${LIBUSB_NAME}-1.0.a
  PATHS
    "${DEPENDS_DIR}/libusb"
    "${DEPENDS_DIR}/libusbx"
    ENV LibUSB_ROOT
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(LibUSB FOUND_VAR LibUSB_FOUND
    REQUIRED_VARS LibUSB_LIBRARIES LibUSB_INCLUDE_DIRS LibUSB_LIBRARIES_STATIC)
