...
public class Dialog1 extends Dialog {
    ...
    private Spinner spin1,spin2, spinFreq;
...
//    }
    ...
    {
    	spinFreq = (Spinner) findViewById(R.id.spin_freq);
...
//        autocheckBox =(CheckBox)findViewById(R.id.ckb2);
    ...
    private void initListener() {
    	spinFreq.setOnItemSelectedListener(new spinFreqItemSelectedListener());
...
//		});
    ...
    private class spinFreqItemSelectedListener implements Spinner.OnItemSelectedListener {

        @Override
        public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
            String str = (String) spinFreq.getSelectedItem();
            TestDmcam.td.devSetModfreq(TestDmcam.getDev(), 1000000 * Integer.parseInt(str.substring(0, str.length()-3)));
        }
