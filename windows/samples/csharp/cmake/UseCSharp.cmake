...
macro( CSHARP_ADD_PROJECT type name )
  ...
  foreach (str ${sources})
      ...
      list(APPEND STR_TMP ${str})
  endforeach()
  set(sources ${STR_TMP})

  # Add custom target and command
  MESSAGE( STATUS "Adding C# ${type} ${name}: '${CSHARP_COMPILER} /target:${type} /out:${name}.${output} /platform:${CSHARP_PLATFORM} ${CSHARP_SDK} ${refs} ${sources_dep}'" )
  add_custom_command(
      COMMENT "Compiling C# ${type} ${name}: '${CSHARP_COMPILER} /target:${type} /out:${name}.${output} /platform:${CSHARP_PLATFORM} ${CSHARP_SDK} ${refs} ${sources}'"
      OUTPUT ${CSHARP_BINARY_DIRECTORY}/${name}.${output}
      COMMAND ${CSHARP_COMPILER}
      ARGS /target:${type} /out:${name}.${output} /platform:${CSHARP_PLATFORM} ${CSHARP_SDK} ${refs} ${sources}
